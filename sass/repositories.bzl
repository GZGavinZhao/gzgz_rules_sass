...
load("//sass/private:toolchains_repo.bzl", "PLATFORMS", "toolchains_repo", "PLATFORM_NAMES")
...
_ATTRS = {
    "sass_version": attr.string(mandatory = True, values = SASS_VERSIONS.keys()),
...
def _sass_repo_impl(repository_ctx):
    ...
    repository_ctx.download_and_extract(
        ...
        integrity = SASS_VERSIONS[sass_version][platform] if SASS_VERSIONS.get(sass_version) else None,
    )
